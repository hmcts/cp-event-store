...
import uk.gov.justice.services.resources.rest.streams.ResetStreamRetryCountResource;
...
class FrameworkApplicationTest {
    ...
    void validateConfiguredResourceClasses() {
        ...
        assertThat(resourceClasses, hasItem(ResetStreamRetryCountResource.class));
    }
}